		...
		if(city == cityName){
			...
			$(this).find('firm').each(function(i){
				...
				if(rank == '0'){
					...
					//build the table
					if(alternate == false){
						$('#midlevel_associate_survey-table_container table >tbody > tr:last').after('<tr style="background-color:#fff;"><td width="27" style="padding:10px; text-align:right; border-right:1px solid #808080; border-bottom:1px solid #808080; width:27px;">'+rank+'</td><td width="440" style="padding:10px; border-right:1px solid #808080; border-bottom:1px solid #808080; width:440px;"><div id="midlevel_associate_survey-table-firmname" class="floatL">'+firmName+'</div><div id="midlevel_associate_survey-clickformore" class="floatR">(Click for survey results)</div><div class="clear"></div></td><td width="71" style="padding:10px; text-align:right; border-right:1px solid #808080; border-bottom:1px solid #808080; width:71px;">'+respondents+'</td><td width="32" style="padding:10px; text-align:right; border-bottom:1px solid #808080; width:32px;">'+firmScore+'</td></tr>');
					
						alternate = true;
					}else{
						$('#midlevel_associate_survey-table_container table >tbody > tr:last').after('<tr style="background-color:rgba(124, 181, 236,0.4);"><td width="27" style="padding:10px; text-align:right; border-right:1px solid #808080; border-bottom:1px solid #808080; width:27px;">'+rank+'</td><td width="440" style="padding:10px; border-right:1px solid #808080; border-bottom:1px solid #808080; width:440px;"><div id="midlevel_associate_survey-table-firmname" class="floatL">'+firmName+'</div><div id="midlevel_associate_survey-clickformore" class="floatR">(Click for survey results)</div><div class="clear"></div></td><td width="71" style="padding:10px; text-align:right; border-right:1px solid #808080; border-bottom:1px solid #808080; width:71px;">'+respondents+'</td><td width="32" style="padding:10px; text-align:right; border-bottom:1px solid #808080; width:32px;">'+firmScore+'</td></tr>');
