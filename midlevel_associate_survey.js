...
function initTable(cityName){
	...
	$('#midlevel_associate_survey-table_container').html('<table cellspacing="0" cellpadding="0" border="0" class="tablescroll" style="width:730px; margin:0; border:1px solid #8F8F8F; border-bottom:none; color:#8F8F8F;"><thead><tr style="background-color:rgba(124, 181, 236,0.4);"><th width="30" style="padding:9px; border-left:1px solid #8F8F8F; border-right:1px solid #8F8F8F; border-top:1px solid #8F8F8F; width:30px;">Rank</th><th width="495" style="padding:10px; border-right:1px solid #8F8F8F; border-top:1px solid #8F8F8F; width:495px;">Firm</th><th width="76" style="padding:10px; border-right:1px solid #8F8F8F; border-top:1px solid #8F8F8F; width:76px;">Respondents</th><th width="33" style="padding:10px; width:33px; border-right:1px solid #8F8F8F; border-top:1px solid #8F8F8F;">Score</th></tr></thead><tbody><tr style="background-color:rgba(124, 181, 236,0.4);"><td width="30" style="width:30px;"></td><td width="495" style="width:495px;"></td><td width="76" style="width:76px;"></td><td width="33" style="width:33px;"></td></tr></tbody></table>');
	...
	$(xml).find('city').each(function(){
		...
		if(city == cityName){
			...
			$(this).find('firm').each(function(i){
				...
				if(rank == '0'){
					$('#midlevel_associate_survey-table_container').html('<table cellspacing="0" cellpadding="0" border="0" class="tablescroll" style="width:730px; margin:0; border:1px solid #8F8F8F; border-bottom:none; color:#8F8F8F;"><thead><tr style="background-color:rgba(124, 181, 236,0.4);"><th width="495" style="padding:10px; border-right:1px solid #8F8F8F; border-top:1px solid #8F8F8F; border-left:1px solid #8F8F8F; width:495px;">Firm</th><th width="76" style="padding:10px; border-right:1px solid #8F8F8F; border-top:1px solid #8F8F8F; width:76px;">Respondents</th><th width="33" style="padding:10px; width:33px; border-top:1px solid #8F8F8F; border-right:1px solid #8F8F8F;">Score</th></tr></thead><tbody><tr style="background-color:#fff;"><td width="495" style="padding:10px; border-right:1px solid #8F8F8F; border-bottom:1px solid #8F8F8F; width:495px;"><div id="midlevel_associate_survey-table-firmname" class="floatL">'+firmName+'</div><div id="midlevel_associate_survey-clickformore" class="floatR">(Click for survey results)</div><div class="clear"></div></td><td width="76" style="padding:10px; text-align:right; border-right:1px solid #8F8F8F; border-bottom:1px solid #8F8F8F; width:76px;">'+respondents+'</td><td width="33" style="padding:10px; text-align:right; border-bottom:1px solid #8F8F8F; border-bottom:1px solid #8F8F8F; width:33px;">'+firmScore+'</td></tr></tbody></table>');
				}else{
					//build the table
					if(alternate == false){
						$('#midlevel_associate_survey-table_container table >tbody > tr:last').after('<tr style="background-color:#fff;"><td width="30" style="padding:10px; text-align:right; border-right:1px solid #8F8F8F; border-bottom:1px solid #8F8F8F; width:30px;">'+rank+'</td><td width="495" style="padding:10px; border-right:1px solid #8F8F8F; border-bottom:1px solid #8F8F8F; width:495px;"><div id="midlevel_associate_survey-table-firmname" class="floatL">'+firmName+'</div><div id="midlevel_associate_survey-clickformore" class="floatR">(Click for survey results)</div><div class="clear"></div></td><td width="76" style="padding:10px; text-align:right; border-right:1px solid #8F8F8F; border-bottom:1px solid #8F8F8F; width:76px;">'+respondents+'</td><td width="33" style="padding:10px; text-align:right; border-bottom:1px solid #8F8F8F; width:33px;">'+firmScore+'</td></tr>');
					
						alternate = true;
					}else{
						$('#midlevel_associate_survey-table_container table >tbody > tr:last').after('<tr style="background-color:rgba(124, 181, 236,0.4);"><td width="30" style="padding:10px; text-align:right; border-right:1px solid #8F8F8F; border-bottom:1px solid #8F8F8F; width:30px;">'+rank+'</td><td width="495" style="padding:10px; border-right:1px solid #8F8F8F; border-bottom:1px solid #8F8F8F; width:495px;"><div id="midlevel_associate_survey-table-firmname" class="floatL">'+firmName+'</div><div id="midlevel_associate_survey-clickformore" class="floatR">(Click for survey results)</div><div class="clear"></div></td><td width="76" style="padding:10px; text-align:right; border-right:1px solid #8F8F8F; border-bottom:1px solid #8F8F8F; width:76px;">'+respondents+'</td><td width="33" style="padding:10px; text-align:right; border-bottom:1px solid #8F8F8F; width:33px;">'+firmScore+'</td></tr>');
...
function initNav(xml){
	...
	$('table.tablescroll > tbody tr').hover(function(){
		...
		$(this).css("cssText", "color: #fff !important; background-color: #8F8F8F !important;");
