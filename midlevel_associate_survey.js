...
function initTable(cityName){
	...
	$('#midlevel_associate_survey-table_container').html('<table cellspacing="0" cellpadding="0" border="0" class="tablescroll" style="width:730px; margin:0; border:1px solid #ADD8E6; border-bottom:none; color:#4169E1;"><thead><tr style="background-color:#87CEFA;"><th width="30" style="padding:10px; border-left:1px solid #c2beac; border-right:1px solid #ADD8E6; border-top:1px solid #ADD8E6; width:30px;">Rank</th><th width="495" style="padding:10px; border-right:1px solid #ADD8E6; border-top:1px solid #ADD8E6; width:495px;">Firm</th><th width="76" style="padding:10px; border-right:1px solid #ADD8E6; border-top:1px solid #ADD8E6; width:76px;">Respondents</th><th width="33" style="padding:10px; width:33px; border-right:1px solid #ADD8E6; border-top:1px solid #ADD8E6;">Score</th></tr></thead><tbody><tr style="background-color:#4682B4;"><td width="30" style="width:30px;"></td><td width="495" style="width:495px;"></td><td width="76" style="width:76px;"></td><td width="33" style="width:33px;"></td></tr></tbody></table>');
