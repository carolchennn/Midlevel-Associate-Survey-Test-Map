...
function initTable(cityName){
	...
	$('#midlevel_associate_survey-table_container').html('<table cellspacing="0" cellpadding="0" border="0" class="tablescroll" style="width:730px; margin:0; border:1px solid #000000; border-bottom:none; color:#000000;"><thead><tr style="background-color:rgba(124, 181, 236,0.4);"><th width="30" style="padding:10px; border-left:1px solid #000000; border-right:1px solid #000000; border-top:1px solid #000000; width:30px;">Rank</th><th width="495" style="padding:10px; border-right:1px solid #000000; border-top:1px solid #000000; width:495px;">Firm</th><th width="76" style="padding:10px; border-right:1px solid #000000; border-top:1px solid #000000; width:76px;">Respondents</th><th width="33" style="padding:10px; width:33px; border-right:1px solid #000000; border-top:1px solid #000000;">Score</th></tr></thead><tbody><tr style="background-color:#000000;"><td width="30" style="width:30px;"></td><td width="495" style="width:495px;"></td><td width="76" style="width:76px;"></td><td width="33" style="width:33px;"></td></tr></tbody></table>');
