...
function initTable(cityName){
	...
	$('#midlevel_associate_survey-table_container').html('<table cellspacing="0" cellpadding="0" border="0" class="tablescroll" style="width:720px; font-size:12px; margin:0; color:#000000; border:1px solid #949494; border-bottom:none; color:#949494;"><thead><tr style="background-color:rgba(124, 181, 236,0.4);"><th width="30" style="padding:10px; border-left:1px solid #949494; border-right:1px solid #949494; border-top:1px solid #949494; width:30px;">Rank</th><th width="490" style="padding:10px; border-right:1px solid #949494; border-top:1px solid #949494; width:490px;">Firm</th><th width="70" style="padding:10px; border-right:1px solid #949494; border-top:1px solid #949494; width:70px;">Respondents</th><th width="30" style="padding:10px; width:30px; border-right:1px solid #949494; border-top:1px solid #949494;">Score</th></tr></thead><tbody><tr style="background-color:rgba(124, 181, 236,0.4);"><td width="30" style="width:30px;"></td><td width="490" style="width:490px;"></td><td width="70" style="width:70px;"></td><td width="30" style="width:30px;"></td></tr></tbody></table>');
	...
	$(xml).find('city').each(function(){
		...
		if(city == cityName){
			...
			$(this).find('firm').each(function(i){
				...
				if(rank == '0'){
					$('#midlevel_associate_survey-table_container').html('<table cellspacing="0" cellpadding="0" border="0" class="tablescroll" style="width:720px; margin:0; border:1px solid #949494; border-bottom:none; color:#949494;"><thead><tr style="background-color:rgba(124, 181, 236,0.4);"><th width="490" style="padding:10px; border-right:1px solid #949494; border-top:1px solid 949494; border-left:1px solid #949494; width:490px;">Firm</th><th width="70" style="padding:10px; border-right:1px solid #949494; border-top:1px solid #949494; width:70px;">Respondents</th><th width="30" style="padding:10px; width:30px; border-top:1px solid #949494; border-right:1px solid #949494;">Score</th></tr></thead><tbody><tr style="background-color:#fff;"><td width="490" style="padding:10px; border-right:1px solid #949494; border-bottom:1px solid #949494; width:490px;"><div id="midlevel_associate_survey-table-firmname" class="floatL">'+firmName+'</div><div id="midlevel_associate_survey-clickformore" class="floatR">(Click for survey results)</div><div class="clear"></div></td><td width="70" style="padding:10px; text-align:right; border-right:1px solid #949494; border-bottom:1px solid #949494; width:70px;">'+respondents+'</td><td width="30" style="padding:10px; text-align:right; border-bottom:1px solid #949494; border-bottom:1px solid #949494; width:30px;">'+firmScore+'</td></tr></tbody></table>');
				}else{
					//build the table
					if(alternate == false){
						$('#midlevel_associate_survey-table_container table >tbody > tr:last').after('<tr style="background-color:#fff;"><td width="30" style="padding:10px; text-align:right; border-right:1px solid #949494; border-bottom:1px solid #949494; width:30px;">'+rank+'</td><td width="490" style="padding:10px; border-right:1px solid #949494; border-bottom:1px solid #949494; width:490px;"><div id="midlevel_associate_survey-table-firmname" class="floatL">'+firmName+'</div><div id="midlevel_associate_survey-clickformore" class="floatR">(Click for survey results)</div><div class="clear"></div></td><td width="70" style="padding:10px; text-align:right; border-right:1px solid #949494; border-bottom:1px solid #949494; width:70px;">'+respondents+'</td><td width="30" style="padding:10px; text-align:right; border-bottom:1px solid #949494; width:30px;">'+firmScore+'</td></tr>');
					
						alternate = true;
					}else{
						$('#midlevel_associate_survey-table_container table >tbody > tr:last').after('<tr style="background-color:rgba(124, 181, 236,0.4);"><td width="30" style="padding:10px; text-align:right; border-right:1px solid #949494; border-bottom:1px solid #949494; width:30px;">'+rank+'</td><td width="490" style="padding:10px; border-right:1px solid #949494; border-bottom:1px solid #949494; width:490px;"><div id="midlevel_associate_survey-table-firmname" class="floatL">'+firmName+'</div><div id="midlevel_associate_survey-clickformore" class="floatR">(Click for survey results)</div><div class="clear"></div></td><td width="70" style="padding:10px; text-align:right; border-right:1px solid #949494; border-bottom:1px solid #949494; width:70px;">'+respondents+'</td><td width="30" style="padding:10px; text-align:right; border-bottom:1px solid #949494; width:30px;">'+firmScore+'</td></tr>');
